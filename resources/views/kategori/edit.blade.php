    ...
    <div class="col col-lg-6 col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          ...
          @endif
          <form action="update/{{$itemkategori->id}}" method="post">
            @csrf
            {{ method_field('patch') }}
            <div class="form-group">
              <label for="kode_kategori">Category Form</label>
